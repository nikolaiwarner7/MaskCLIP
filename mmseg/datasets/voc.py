...
## Custom dataset class for RGBS
@DATASETS.register_module()
class PascalVOCDatasetRGBS(CustomDataset):
    """Pascal VOC dataset.
    ...
    def __init__(self, split, **kwargs):
        super(PascalVOCDatasetRGBS, self).__init__(
            img_suffix='.npy', seg_map_suffix='.npy', split=split, **kwargs)
        assert osp.exists(self.img_dir) and self.split is not None
