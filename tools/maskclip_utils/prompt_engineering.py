...
def parse_args():
    ...
    parser.add_argument('--class-set', default=['voc'], nargs='+',
        choices=['city', 'ade', 'stuff', 'voc', 'coco', 'context', 'acontext', 'mickey', 'batman', 'mario', 'gates', 'blur', 'sports', 'car_brands', 'batman_ext', 'car_color'],
