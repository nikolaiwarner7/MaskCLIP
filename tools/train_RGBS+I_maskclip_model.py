...
def main():
    ...
    cfg.data.train.img_dir = 'Inst_Seg_RGBS_Images/train'
    cfg.data.train.ann_dir = 'Inst_Seg_RGBS_Annotations/train'
    cfg.data.train.split = 'ImageSets/Segmentation/RGBS+I_train.txt'
    ...
    cfg.data.val.ann_dir = 'Inst_Seg_RGBS_Annotations/val'
    cfg.data.val.split = 'ImageSets/Segmentation/RGBS+I_val.txt'
    # This config data below only used to set datatype to npy, so should be recyclable 
